...
pretrained_net = torch.load('/media/sdc/wpguan/zhangxinjie/paper_sft_denoise/experiments/[4.23]basicmodelx4_noise_c15/models/686000_G.pth')
...
#no enlarge the pictures
#adaptive_norm_net['HR_branch.0.weight'] = pretrained_net['model.2.weight']
#adaptive_norm_net['HR_branch.0.bias'] = pretrained_net['model.2.bias']
#adaptive_norm_net['HR_branch.2.weight'] = pretrained_net['model.4.weight']
#adaptive_norm_net['HR_branch.2.bias'] = pretrained_net['model.4.bias']
...
torch.save(adaptive_norm_net, '/media/sdc/wpguan/zhangxinjie/paper_sft_denoise/experiments/[4.23]basicmodelx4_noise_c15/pretainmodel/686000_G.pth')